...
const extraProducts: Product[] = [
  { id: "milka-chocolate", name: { fr: "Chocolat Milka", en: "Milka Chocolate", ar: "Milka Chocolate" }, category: "Chocolate", price: 4.9, image: "MI", barcode: "619300001", stock: { bizerte: 28, tunis: 22 } },
  { id: "nutella-350", name: { fr: "Nutella 350g", en: "Nutella 350g", ar: "Nutella 350g" }, category: "Spreads", price: 13.5, image: "NU", barcode: "619300002", stock: { bizerte: 16, tunis: 12 } },
  { id: "angel-curls", name: { fr: "Angel Curls", en: "Angel Curls", ar: "Angel Curls" }, category: "Snacks", price: 2.5, image: "AC", barcode: "619300003", stock: { bizerte: 34, tunis: 26 } },
  { id: "swiss-chocolate", name: { fr: "Swiss Chocolate", en: "Swiss Chocolate", ar: "Swiss Chocolate" }, category: "Chocolate", price: 5.5, image: "SC", barcode: "619300004", stock: { bizerte: 20, tunis: 16 } },
  { id: "kinder-bueno", name: { fr: "Kinder Bueno", en: "Kinder Bueno", ar: "Kinder Bueno" }, category: "Chocolate", price: 3.8, image: "KB", barcode: "619300005", stock: { bizerte: 32, tunis: 28 } },
  { id: "oreo", name: { fr: "Oreo Original", en: "Oreo Original", ar: "Oreo Original" }, category: "Biscuits", price: 3.2, image: "OR", barcode: "619300006", stock: { bizerte: 36, tunis: 30 } },
  { id: "twix", name: { fr: "Twix", en: "Twix", ar: "Twix" }, category: "Chocolate", price: 2.8, image: "TW", barcode: "619300007", stock: { bizerte: 30, tunis: 24 } },
  { id: "snickers", name: { fr: "Snickers", en: "Snickers", ar: "Snickers" }, category: "Chocolate", price: 3.2, image: "SN", barcode: "619300008", stock: { bizerte: 28, tunis: 22 } },
  { id: "mars", name: { fr: "Mars", en: "Mars", ar: "Mars" }, category: "Chocolate", price: 3.0, image: "MA", barcode: "619300009", stock: { bizerte: 30, tunis: 20 } },
  { id: "kitkat", name: { fr: "KitKat", en: "KitKat", ar: "KitKat" }, category: "Chocolate", price: 3.0, image: "KK", barcode: "619300010", stock: { bizerte: 26, tunis: 18 } },
  { id: "mms", name: { fr: "M&M's", en: "M&M's", ar: "M&M's" }, category: "Chocolate", price: 4.5, image: "MM", barcode: "619300011", stock: { bizerte: 18, tunis: 16 } },
  { id: "haribo", name: { fr: "Haribo", en: "Haribo", ar: "Haribo" }, category: "Candy", price: 4.2, image: "HA", barcode: "619300012", stock: { bizerte: 22, tunis: 18 } },
  { id: "chupa-chups", name: { fr: "Chupa Chups", en: "Chupa Chups", ar: "Chupa Chups" }, category: "Candy", price: 0.8, image: "CC", barcode: "619300013", stock: { bizerte: 80, tunis: 60 } },
  { id: "pringles", name: { fr: "Pringles", en: "Pringles", ar: "Pringles" }, category: "Chips", price: 8.5, image: "PR", barcode: "619300014", stock: { bizerte: 18, tunis: 12 } },
  { id: "doritos", name: { fr: "Doritos", en: "Doritos", ar: "Doritos" }, category: "Chips", price: 4.8, image: "DO", barcode: "619300015", stock: { bizerte: 24, tunis: 18 } },
  { id: "lays-classic", name: { fr: "Lay's Classic", en: "Lay's Classic", ar: "Lay's Classic" }, category: "Chips", price: 3.5, image: "LY", barcode: "619300016", stock: { bizerte: 40, tunis: 32 } },
  { id: "cheetos", name: { fr: "Cheetos", en: "Cheetos", ar: "Cheetos" }, category: "Chips", price: 3.2, image: "CE", barcode: "619300017", stock: { bizerte: 35, tunis: 25 } },
  { id: "popcorn", name: { fr: "Popcorn sale", en: "Salted Popcorn", ar: "Salted Popcorn" }, category: "Snacks", price: 1.7, image: "PO", barcode: "619300018", stock: { bizerte: 44, tunis: 28 } },
  { id: "crackers", name: { fr: "Crackers sales", en: "Salted Crackers", ar: "Salted Crackers" }, category: "Biscuits", price: 2.2, image: "CR", barcode: "619300019", stock: { bizerte: 38, tunis: 24 } },
  { id: "tom-wafer", name: { fr: "Gaufrette Tom", en: "Tom Wafer", ar: "Tom Wafer" }, category: "Biscuits", price: 1.0, image: "TO", barcode: "619300020", stock: { bizerte: 54, tunis: 30 } },
  { id: "boga-lim", name: { fr: "Boga Lim 24cl", en: "Boga Lim 24cl", ar: "Boga Lim 24cl" }, category: "Drinks", price: 1.6, image: "BL", barcode: "619300021", stock: { bizerte: 48, tunis: 28 } },
  { id: "coca-cola", name: { fr: "Coca-Cola 24cl", en: "Coca-Cola 24cl", ar: "Coca-Cola 24cl" }, category: "Drinks", price: 2.0, image: "CO", barcode: "619300022", stock: { bizerte: 36, tunis: 30 } },
  { id: "fanta-orange", name: { fr: "Fanta Orange 24cl", en: "Fanta Orange 24cl", ar: "Fanta Orange 24cl" }, category: "Drinks", price: 1.9, image: "FA", barcode: "619300023", stock: { bizerte: 36, tunis: 26 } },
  { id: "marwa-water", name: { fr: "Eau Marwa 1.5L", en: "Marwa Water 1.5L", ar: "Marwa Water 1.5L" }, category: "Drinks", price: 0.95, image: "MW", barcode: "619300024", stock: { bizerte: 60, tunis: 40 } },
  { id: "delice-milk", name: { fr: "Lait Delice 1L", en: "Delice Milk 1L", ar: "Delice Milk 1L" }, category: "Dairy", price: 1.7, image: "DM", barcode: "619300025", stock: { bizerte: 30, tunis: 24 } },
  { id: "vitalait-yogurt", name: { fr: "Yaourt Vitalait", en: "Vitalait Yogurt", ar: "Vitalait Yogurt" }, category: "Dairy", price: 0.7, image: "VY", barcode: "619300026", stock: { bizerte: 60, tunis: 42 } },
  { id: "danette", name: { fr: "Danette Chocolat", en: "Danette Chocolate", ar: "Danette Chocolate" }, category: "Dairy", price: 1.3, image: "DA", barcode: "619300027", stock: { bizerte: 36, tunis: 28 } },
  { id: "cheese-triangles", name: { fr: "Fromage triangles", en: "Cheese Triangles", ar: "Cheese Triangles" }, category: "Dairy", price: 3.8, image: "CT", barcode: "619300028", stock: { bizerte: 25, tunis: 20 } },
  { id: "bondin-coffee", name: { fr: "Cafe Bondin", en: "Bondin Coffee", ar: "Bondin Coffee" }, category: "Groceries", price: 6.5, image: "CB", barcode: "619300029", stock: { bizerte: 18, tunis: 14 } },
  { id: "tea-pack", name: { fr: "The vert", en: "Green Tea", ar: "Green Tea" }, category: "Groceries", price: 3.5, image: "GT", barcode: "619300030", stock: { bizerte: 24, tunis: 20 } },
  { id: "sugar-1kg", name: { fr: "Sucre 1kg", en: "Sugar 1kg", ar: "Sugar 1kg" }, category: "Groceries", price: 1.8, image: "SU", barcode: "619300031", stock: { bizerte: 30, tunis: 24 } },
  { id: "shampoo", name: { fr: "Shampooing 400ml", en: "Shampoo 400ml", ar: "Shampoo 400ml" }, category: "Hygiene", price: 8.5, image: "SH", barcode: "619300032", stock: { bizerte: 18, tunis: 14 } },
  { id: "deodorant", name: { fr: "Deodorant spray", en: "Deodorant Spray", ar: "Deodorant Spray" }, category: "Hygiene", price: 7.5, image: "DE", barcode: "619300033", stock: { bizerte: 22, tunis: 16 } },
  { id: "toothbrush", name: { fr: "Brosse a dents", en: "Toothbrush", ar: "Toothbrush" }, category: "Hygiene", price: 2.6, image: "TB", barcode: "619300034", stock: { bizerte: 40, tunis: 28 } },
  { id: "liquid-soap", name: { fr: "Savon liquide 500ml", en: "Liquid Soap 500ml", ar: "Liquid Soap 500ml" }, category: "Hygiene", price: 3.9, image: "LS", barcode: "619300035", stock: { bizerte: 30, tunis: 22 } },
  { id: "toilet-paper", name: { fr: "Papier hygienique Lilas", en: "Lilas Toilet Paper", ar: "Lilas Toilet Paper" }, category: "Household", price: 4.5, image: "LP", barcode: "619300036", stock: { bizerte: 25, tunis: 20 } },
  { id: "kitchen-towels", name: { fr: "Essuie-tout Lilas", en: "Lilas Kitchen Towels", ar: "Lilas Kitchen Towels" }, category: "Household", price: 5.2, image: "KT", barcode: "619300037", stock: { bizerte: 20, tunis: 16 } },
  { id: "dishwashing-liquid", name: { fr: "Liquide vaisselle 500ml", en: "Dishwashing Liquid 500ml", ar: "Dishwashing Liquid 500ml" }, category: "Household", price: 3.0, image: "DL", barcode: "619300038", stock: { bizerte: 28, tunis: 22 } },
  { id: "aa-batteries", name: { fr: "Piles AA", en: "AA Batteries", ar: "AA Batteries" }, category: "Household", price: 4.5, image: "AA", barcode: "619300039", stock: { bizerte: 30, tunis: 24 } },
  { id: "candles", name: { fr: "Bougies", en: "Candles", ar: "Candles" }, category: "Household", price: 2.0, image: "CA", barcode: "619300040", stock: { bizerte: 35, tunis: 20 } },
  { id: "ooredoo-recharge-10", name: { fr: "Recharge Ooredoo 10 DT", en: "Ooredoo Recharge 10 DT", ar: "Ooredoo Recharge 10 DT" }, category: "Services", price: 10, image: "10", barcode: "619300041", stock: { bizerte: 40, tunis: 30 } },
  { id: "orange-recharge-5", name: { fr: "Recharge Orange 5 DT", en: "Orange Recharge 5 DT", ar: "Orange Recharge 5 DT" }, category: "Services", price: 5, image: "OR", barcode: "619300042", stock: { bizerte: 40, tunis: 30 } },
  { id: "tt-recharge-10", name: { fr: "Recharge TT 10 DT", en: "TT Recharge 10 DT", ar: "TT Recharge 10 DT" }, category: "Services", price: 10, image: "TT", barcode: "619300043", stock: { bizerte: 40, tunis: 30 } },
];

const catalogSeed = [...products, ...extraProducts];
...
const categoryLabels: Record<string, LocalizedText> = {
  ...
  Chocolate: { fr: "Chocolat", en: "Chocolate", ar: "Chocolate" },
  Spreads: { fr: "Pates a tartiner", en: "Spreads", ar: "Spreads" },
  Biscuits: { fr: "Biscuits", en: "Biscuits", ar: "Biscuits" },
  Candy: { fr: "Bonbons", en: "Candy", ar: "Candy" },
  Chips: { fr: "Chips", en: "Chips", ar: "Chips" },
  Dairy: { fr: "Produits laitiers", en: "Dairy", ar: "Dairy" },
  Groceries: { fr: "Epicerie", en: "Groceries", ar: "Groceries" },
};
...
export default function Home() {
  const [catalogProducts, setCatalogProducts] = useState<Product[]>(catalogSeed);
  ...
  useEffect(() => {
    ...
    fetch(`${apiBase.replace(/\/$/, "")}/api/products`)
      ...
      .catch(() => {
        setCatalogProducts(catalogSeed);
      });
  }, []);
